            ...
            $.ajax({
                ...
                success: function (data){
                    ...
                    for (var i=0;i<data.length;i++){
                        $('#tab-medicament').append('<tr><td id="medId">'+data[i].medId+'</td><td>'+data[i].depotLegal+'</td><td>'+data[i].nomCommercial+'</td><td>'+data[i].composition+'</td><td>'+data[i].effet+'</td><td>'+data[i].contreIndic+'</td><td>'+data[i].famCode+'<br><br><a type="submit" href="/medicament/'+data[i].medIdclass+'"class="btn btn-primary">Info</a></td></tr>')
                    }
                },
                error: function (data) {
                    alert("error");
